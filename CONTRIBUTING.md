# Contributing to pkg-rpm-audioreach-audio-utils
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-rpm-audioreach-audio-utils.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-rpm-audioreach-audio-utils/pulls) from your branch to `main`.
